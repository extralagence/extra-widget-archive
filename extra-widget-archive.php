 ...
 * Text Domain:       extra-widget-archive
 * License:           GPL-2.0+
...
class Extra_Widget_Archive extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'extra-widget-archive';
...
add_action( 'widgets_init', create_function( '', 'register_widget("Extra_Widget_Archive");' ) );